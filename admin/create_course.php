...
<div class="page-content-wrapper border-none shadow-none m-0 pt-4">
    <h1 class="h4 mb-1">Create New Course</h1>
    <p class="mb-4">Follow these simple steps to set up your new course.</p>
    <!-- Card START -->
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <input name="title" class="form-control" type="text"
                                        placeholder="Enter course title" value="Introduction to Learning Excellence"
                                        required>
                                </div>
                                ...
                                <div class="col-12 d-none">
                                    ...
                                    <textarea name="short_desc" class="form-control" rows="4"
                                        placeholder="Enter keywords" require>No short description added</textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="duration" class="form-control" type="text"
                                        placeholder="Enter course time" value="12h 30m" require>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="price" type="text" class="form-control"
                                        placeholder="Enter course price" value="3500" require>
                                </div>
                                <!-- Course price -->
                                <div class="col-md-6">
                                    <label class="form-label">Total Lectures</label>
                                    <input name="total_lectures" type="text" class="form-control"
                                        placeholder="Enter total lectures" value="27" require>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="language" type="text" class="form-control"
                                        placeholder="Enter course language" value="Bangla" require>
                                </div>
                                ...
                                <div class="col-md-12 d-none">
                                    ...
                                    <textarea name="description" class="form-control" rows="5"
                                        ...
                                        require>No description added</textarea>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="d-md-flex justify-content-between align-items-start mt-4">
                                    ...
                                    <div class="text-md-end">
                                        ...
                                        <p class="mb-0 small mt-1">Once you click "Submit a Course", your course will be
                                            uploaded and marked as pending for review.</p>
                                    </div>
                                </div>
                            </div>
                        </div>

...
function createLecture(form) {
  // elements goes here
  const lectureHolder = document.getElementById("lectureHolder");
  ...
  // insert lecture html
  lectureHolder.insertAdjacentHTML(
    "beforeend",
    `
    <div class="accordion-item mb-3">
      ...
      <div class="accordion-body mt-3">
          ...
          <a href="#" onclick="setLectureId('${lectureId}')" class="btn btn-sm btn-dark mb-0" data-bs-toggle="modal" data-bs-target="#addTopic"><i class="bi bi-plus-circle me-2"></i>Add topic</a>
...
function createTopic(form) {
  // elements goes here
  const topicHolder = document.getElementById("topic-" + currentLectureId);
